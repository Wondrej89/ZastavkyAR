...
const SHELL = ['./','./index.html','./styles.css','./manifest.webmanifest','./build-version.json','./icons/icon.svg','./icons/icon-192.svg','./icons/icon-512.svg','./js/app.js','./js/build-update.js','./js/build-version.js','./js/config.js','./js/dataset-status.js','./js/geo.js','./js/storage.js','./js/orientation.js','./api/departures.js'];
